...
function AboutOurFirm () {
    return (
        <div>
            ...
            <h5 className="our-firm-content">Founded in Richmond, Virginia, A.G. Reese & Associates, P.C. has been serving the local community with integrity and expertise. As a small, dedicated firm, we pride ourselves on building long-term relationshipswith our clients and delivering accurate, reliable accounting services.</h5>
