    ...
    return(
        <div>
            <div className="terms_header">
                ...
                <p>These terms and conditions (the "Terms and Conditions") govern the use of agreese.com (the "Site"). This Site is owned and operated by {Owner}. This Site is a service.</p>
